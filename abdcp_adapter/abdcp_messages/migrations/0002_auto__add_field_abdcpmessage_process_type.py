...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ABDCPMessage.process_type'
        db.add_column(u'abdcp_messages_abdcpmessage', 'process_type',
                      self.gf('django.db.models.fields.TextField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ABDCPMessage.process_type'
        db.delete_column(u'abdcp_messages_abdcpmessage', 'process_type')
