...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ABDCPMessage.stated_creation'
        db.add_column(u'abdcp_messages_abdcpmessage', 'stated_creation',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ABDCPMessage.stated_creation'
        db.delete_column(u'abdcp_messages_abdcpmessage', 'stated_creation')
